...
namespace A_5조_EduMgr
{
    public partial class Form2 : Form
    {
        ...
        private void DataLoad()
        {
            ...
            Conn.Open();
            var Comm01 = new MySqlCommand("Select name, edunum, birth, email, phone from t_userinfo where userid = '" + UserId + "'", Conn);
            ...
            myRead01.Close();
            subtmp.Clear();
            var Comm02 = new MySqlCommand("Select subject from t_user_subject where edunum = " + EduNum + "", Conn);
        ...
        private void SubjectLoad()
        {
            var Conn = new MySqlConnection(Constr);
            Conn.Open();
            var Comm = new MySqlCommand("Select subject from t_subject", Conn);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                var Conn = new MySqlConnection(Constr);
                Conn.Open();
                var myCom01 = new MySqlCommand("delete from t_user_subject where edunum = " + EduNum + "", Conn);
                ...
                foreach (string sub in this.lbMySubject.Items)
                {
                    ...
                    var myCom02 = new MySqlCommand(strSQL, Conn);
